...
# Assumes there is a file named "config" that exports a DB variable with the
# psql connection string. and that there's a file ELECTION_NUM.zip which is the
# zip downloaded off the GA web site
